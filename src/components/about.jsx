  ...
  return (
    <motion.div
      ...
      <section className="grid gap-2 md:grid-cols-2 md:px-[80px] md:items-center md:text-left">
        <h1 className="pt-10 px-20 text-left md:hidden block text-4xl font-serif font-bold">About Me</h1>
        ...
        <div className="px-20 md:pt-20 md:px-20 sm:px-20">
          <h1 className="hidden md:block text-4xl font-serif font-bold pb-10">About Me</h1>
